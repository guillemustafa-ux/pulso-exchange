...
type BadgeVariant = 'success' | 'danger' | 'neutral' | 'info' | 'realtime'
...
const VARIANT_CLASS: Record<BadgeVariant, string> = {
  ...
  // Cian = "lo vivo": datos fluyendo en tiempo real. Mismo tono que positive
  // a propósito — en PULSO el turquesa siempre significa movimiento.
  realtime: 'bg-positive/10 text-positive border-positive/25',
}
